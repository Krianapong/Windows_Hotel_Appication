...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Cordia New", 1, 18)); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(JTPass, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(JTUser, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(115, 115, 115)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        FMRegister.setVisible(true);
        setVisible(false);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            String TUser = JTUser.getText();
            String TPass = JTPass.getText();
            String sql = "SELECT * FROM account WHERE Username='"+TUser+"' AND Password='"+TPass+"' ";
            con = DriverManager.getConnection("jdbc:mysql://localhost/hotel","root","");
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            if(rs.next()){
                String name = rs.getString("Name");
                String ID = rs.getString("ID_Acc");
                JLabel label = new JLabel("Welcome "+name+" ");
                label.setFont(new Font("Cordia New", Font.BOLD, 18));
                Main user = new Main();
                user.set(ID);
                user.setNam(name);
                JOptionPane.showMessageDialog(null,label);
                if(rs.getInt("Admin") == 1){
                    AdminMain FUM = new AdminMain();
                    FUM.setVisible(true);
                    setVisible(false);
                }
                else{
                    UserMain FUM = new UserMain();
                    FUM.setVisible(true);
                    setVisible(false);
                }
            }
            else{
                JOptionPane.showMessageDialog(null, "Incerrect  Username / Password ");
            }
        }
        catch(Exception ex){
